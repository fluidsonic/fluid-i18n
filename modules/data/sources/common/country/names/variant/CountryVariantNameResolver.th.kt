...
internal val countryVariantNameResolver_th: LocalizedValueResolver<String, String> =
    LocalizedValueResolver.buildMap {
      ...
      put(key = "CD", value = "คองโก (สาธารณรัฐประชาธิปไตย)", language = "th")
      put(key = "CF", value = "สาธารณรัฐแอฟริกากลาง", language = "th")
      put(key = "CG", value = "คองโก (สาธารณรัฐ)", language = "th")
      put(key = "CH", value = "สวิตเซอร์แลนด์", language = "th")
      put(key = "CI", value = "ไอวอรี่โคสต์", language = "th")
      ...
      put(key = "CZ", value = "สาธารณรัฐเช็ก", language = "th")
      ...
      put(key = "FK", value = "หมู่เกาะฟอล์กแลนด์ (อิสลาส มาลวินาส)", language = "th")
      ...
      put(key = "SZ", value = "สวาซิแลนด์", language = "th")
      ...
      put(key = "TL", value = "ติมอร์ตะวันออก", language = "th")
